...
namespace ldtk {
    ...
    public:
        ...
        World(const nlohmann::json& j, Project* p);
        World(const nlohmann::json& j, Project* p, bool external_levels, FileLoader file_loader);

    private:
        void parseLayout(const nlohmann::json& j);
        void fillLevelNeighbours();
